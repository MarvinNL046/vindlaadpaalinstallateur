...
export const metadata: Metadata = {
  title: 'Privacybeleid | VindLaadpaalInstallateur.nl',
  description: 'Privacybeleid van VindLaadpaalInstallateur.nl. Lees hoe wij omgaan met uw gegevens.',
};
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            VindLaadpaalInstallateur.nl respecteert uw privacy en is toegewijd aan het beschermen van uw persoonsgegevens.
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            (bijvoorbeeld bij het versturen van een e-mail of offerte-aanvraag).
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            Gegevens worden alleen gedeeld wanneer dit wettelijk vereist is of noodzakelijk voor de werking van onze dienst.
          </p>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">8. Autoriteit Persoonsgegevens</h2>
          <p className="mb-4">
            Indien u een klacht heeft over de verwerking van uw persoonsgegevens, kunt u contact opnemen met
            de Autoriteit Persoonsgegevens. U vindt de contactgegevens via{' '}
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Wij behouden ons het recht voor dit privacybeleid te wijzigen. Belangrijke wijzigingen worden op
            onze website gecommuniceerd. Wij adviseren u regelmatig deze pagina te raadplegen.
          </p>
        </section>
      </div>
    </div>
