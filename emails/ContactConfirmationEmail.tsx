...
export const ContactConfirmationEmail = ({
  ...
  return (
    <BaseTemplate preview="Bedankt voor uw bericht - VindLaadpaalInstallateur">
      ...
      <Text style={paragraph}>
        ...
        over laadpaal installateurs in Nederland.
      </Text>

      <Text style={signature}>
        Met vriendelijke groet,
        <br />
        <strong>Team VindLaadpaalInstallateur</strong>
      </Text>
    </BaseTemplate>
  );
};
